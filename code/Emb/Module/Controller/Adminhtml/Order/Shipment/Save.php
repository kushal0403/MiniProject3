...
namespace Emb\Module\Controller\Adminhtml\Order\Shipment;
...
class Save extends \Magento\Shipping\Controller\Adminhtml\Order\Shipment\Save
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            // Get the value from your custom model
            $awbnumber = $this->customModel->getAwbNumber();
            $tracking[] = array("carrier_code" => "custom", "title" => "Custom Value", "number" =>$awbnumber);
            ...
            $shipmentCreatedMessage = __('The shipment has been created by team3.');
